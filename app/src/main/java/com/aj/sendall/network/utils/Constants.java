...
public class Constants {
    ...
    public static final String ADV_VALUE_DATA_AVAILABLE = "3";

    public static final String ADV_KEY_SERVER_ADDRESS = "4";
    public static final String ADV_KEY_SERVER_PORT = "5";
}
