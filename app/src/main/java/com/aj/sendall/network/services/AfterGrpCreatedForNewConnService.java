...
public class AfterGrpCreatedForNewConnService extends IntentService{
    ...
    public AfterGrpCreatedForNewConnService() {
        super(AfterGrpCreatedForNewConnService.class.getName());
    }
    @Override
    protected void onHandleIntent(Intent intent) {
        ...
        networkName = intent.getStringExtra(NET);
        passPhrase = intent.getStringExtra(PASS);
        run();
    }
                ...
                try {
                    ...
                    appManager.wifiP2pManager.addLocalService(appManager.channel, serviceInfo, new WifiP2pManager.ActionListener() {
                        ...
                        public void onSuccess() {
                            ...
                            //Starting the server.
                            NewConnCreationServer newConnCreationServer = new NewConnCreationServer(serverSocket, appManager, Connector.currentInstance);
                            ConnCreationServerService.start(context.getApplicationContext(), newConnCreationServer);
